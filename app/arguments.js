...
const { isIntervalValid, isURLValid, isPathValid } = require('./validator');
...
const urlArgument = {
  ...
  options: {
    ...
    nargs: 1,
    description:
      'URL of the Page in the form [http|https]://[host]:[port]/[path]?[query]',
    type: 'string',
  },
};
...
const parse = () => {
  args = yargs
    ...
    .epilogue(
      'for more information, go to https://github.com/the-mod/browser-screen-grab',
    )
